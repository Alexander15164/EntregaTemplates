...
class TablaDatosWC extends HTMLElement{
  ...
  connectedCallback() {
    ...
    divEleccion.appendChild(document.createElement('br'));
    divEleccion.appendChild(document.createElement('br'));

    var divPaginador = document.createElement('div');
    var cargador = document.createElement('select');
    cargador.style.width = '300px';
    cargador.style.height = '25px';
    cargador.style.fontSize = '15px';
    ...
    cargador.appendChild(option0);
    option1.setAttribute('value', '1');
    option1.setAttribute('id', '1');
    option1.innerText = '1';
    cargador.appendChild(option1);
    option2.setAttribute('value', '2');
    option2.innerText = '2';
    cargador.appendChild(option2);
    option3.setAttribute('value', '3');
    option3.innerText = '3';
    cargador.appendChild(option3);
    option4.setAttribute('value', '4');
    option4.innerText = '4';
    cargador.appendChild(option4);
    option5.setAttribute('value', '5');
    option5.innerText = '5';
    cargador.appendChild(option5);
    cargador.onchange = function () {
      var selectedOption = this.options[cargador.selectedIndex];
      NumeroRegistros = parseInt(selectedOption.value);
    };

    divPaginador.appendChild(cargador);
            ...
            function (data) {
              if (data.length != null) {
                ...
                cargar.onclick = function () {
                  ...
                  var pagina = Math.ceil(tamaño / NumeroRegistros);
                  for (var i = 0; i < pagina; i++) {

                    let boton = document.createElement('input');
                    boton.setAttribute('first', (i * NumeroRegistros));
                    ...
                    boton.onclick = function () {
                      ...
                      var final = parseInt(id) + NumeroRegistros;
                ...
                div.innerHTML = 'No hay datos para esta entidad';
              }

            })
            .catch(function (error) {
              div.innerHTML = 'No hay datos para esta entidad';
              console.log('Fech: ' + error.message);
            }
          );
